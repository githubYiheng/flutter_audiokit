...
/// Auto-panner effect node (SoundpipeAudioKit).
///
/// Mirrors SoundpipeAudioKit's `AutoPanner` class.
/// Note: Waveform (Table) parameter is set to default (positiveSine) on native side.
class AutoPanner extends Node {
  AutoPanner._(this._nodeId, this._input);
  ...
  @override
  String get nodeType => 'AutoPanner';
  ...
  static Future<AutoPanner> create(
    Node input, {
    ...
    return AutoPanner._(nodeId, input)
