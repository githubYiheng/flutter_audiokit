...
/// Peaking parametric equalizer filter effect node (SoundpipeAudioKit).
///
/// Mirrors SoundpipeAudioKit's `PeakingParametricEqualizerFilter` class.
class PeakingParametricEqualizerFilter extends Node {
  PeakingParametricEqualizerFilter._(this._nodeId, this._input);
  ...
  @override
  String get nodeType => 'PeakingParametricEqualizerFilter';
  ...
  static Future<PeakingParametricEqualizerFilter> create(
    Node input, {
    ...
    return PeakingParametricEqualizerFilter._(nodeId, input)
